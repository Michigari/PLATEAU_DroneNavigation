...
public class Main : MonoBehaviour {
    ...
    public void RandomTest (int n) {
        ...
        for (int t = 0; t < n; t++) {
            Vector3 v1;
            do {
                v1 = new Vector3(-0.5f, -0.02f, -0.3f);/*( 野球場4.03f,-0.02f,0.37f 競技場4.2f,0,0 東京駅-0.5f,-0.02f,-0.3f
            ...
            for (int i = 0; i < RandomTestNumber; i++) {
                Vector3 v2t;
                do {
                    v2t = new Vector3(4.2f, 0, 0);/*( 橋-1.781f,-0.07f,1.108f 町はずれ 1.62f, -0.04f, 0.95f これはだめ//4.25f,-0.03f,0.01f
